  ...
  module Pf2egear
    class PF2EtchPowerCmd
      ...
      def handle
        ...
        client.emit_success t('pf2egear.rune_potency_set', :rune => self.operation.titlecase, :char => @char.name, :item_name => @item.nickname, :old_rune_lvl => old_rune_lvl, :rune_lvl => self.rune_lvl)
      end
    end
  end
end
